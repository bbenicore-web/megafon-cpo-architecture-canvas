...
4. **Добавление** — кнопки «+» в секциях или меню **«+ Добавить...»** в toolbar (домен, секция, плитка, CPO, команда, flow, RACI и др.)
5. **Удаление** — кнопка «Удалить» в панели или **×** при наведении на элемент (любой блок, без ограничений «последний элемент»)
